...
<body>
    <div class="header"><h1>📊 TTA Report History</h1><p>Custom Report By Nitesh Kumar</p></div>
...
<head>
    ...
    <title>Nitesh Automation Report</title>
    <style>
        ${this.getStyles()}
    </style>
</head>
<body>
    <div class="header">
        <h1>🎭 Nitesh Automation Report</h1>
        <p class="header-subtitle">Custom Report By Nitesh Kumar</p>
    </div>
